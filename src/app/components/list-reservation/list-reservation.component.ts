...
import { Component, ComponentFactoryResolver, OnDestroy, OnInit, ViewChild, ViewContainerRef, inject } from '@angular/core';
import { FontAwesomeModule } from '@fortawesome/angular-fontawesome';
import { Subscription } from 'rxjs';
import { IReserveUsuarioListResponse } from '../../models/dtos/reserve-usuario-list';
import {
  ITokenPayload
} from '../../models/dtos/token-payload';
import { AuthService } from '../../service/auth.service';
import { ReservaService } from '../../service/reserva.service';
import { Router } from '@angular/router';
import { PdfService } from '../../service/pdf.service';
import { ReservePdfComponent } from '../reserve-pdf/reserve-pdf.component';
  ...
  template: `
    <div class="min-h-96 space-y-3 px-4">
      ...
      <div class="flex flex-col justify-center items-center text-center">
        ...
        <p class="text-2xl font-bold text-zinc-900">No reservations found</p>
...
export class ListReservationComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.#reservaService.listAllByUsuario(this.usuario?.user.id!).subscribe({
      next: (response) => {
